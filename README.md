...
В текущей реализации пункт меню **«Пуск → Запустить Анализ кода»** (сочетание **Ctrl+Shift+L** / **Cmd+Shift+L**) запускает сканер по тексту активной вкладки; результаты отображаются на вкладке **«Лексемы»** нижней панели.
...
- **Пуск → Запустить Анализ кода** — запуск сканера; открывается вкладка **Лексемы** с таблицей результатов.
